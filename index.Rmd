...
<img src="./img/figure1.jpg" style="width:90%"  align="center" >
...
- Determining exposure environmenents with high sexual dimorphisms. Exposome Data Challenge 2021 wiinner application [application](https://teff-package.github.io/teff/code.html).
...
- Source: [teff_0.1.0.tar.gz](https://teff-package.github.io/teff/bin/teff_0.1.0.tar.gz)

or binaries

- Debian Linux, R-devel, GCC: [teff_0.1.0_R_x86_64-pc-linux-gnu.tar.gz](https://teff-package.github.io/teff/bin/teff_0.1.0_R_x86_64-pc-linux-gnu.tar.gz)
- Windows Server 2022, R-devel, 64 bit: [teff_0.1.0.zip](https://teff-package.github.io/teff/bin/teff_0.1.0.zip) 
- macOS 10.13.6 High Sierra, R-release, CRAN's setup: [teff_0.1.0.tgz](https://teff-package.github.io/teff/bin/teff_0.1.0.tgz)


and, for instance, install for Windows with 

<code>
library(devtools)
</code>
</br><code>
install_local("teff_0.1.0.zip", dependencies=TRUE)
</code>
...
<i class="fas fa-flask"></i>&nbsp; [ISGlobal](https://www.isglobal.org/en)<br />
<i class="fab fa-github"></i>&nbsp; [BRGE](https://github.com/isglobal-brge)<br />
<i class="fas fa-envelope fa-lg"></i>&nbsp; [alejandro.caceres@isglobal.org](mailto:alejandro.caceres@isglobal.org) <br />
